...
api: 'PUT https://api2.ecomailapp.cz/lists/{list_id}/update-subscriber-bulk'
...
$listId = 1;
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "https://api2.ecomailapp.cz/lists/{$listId}/update-subscriber-bulk");
